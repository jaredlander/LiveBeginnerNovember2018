...
organized by
[O’Reilly](https://www.safaribooksonline.com/live-training/courses/beginning-r-programming/0636920210504/).
...
``` r
newProject <- usethis::use_course('https://github.com/jaredlander/LiveBeginnerNovember2018/archive/master.zip')
```
...
LiveBeginnerNovember2018. You can see this in the top right of RStudio
